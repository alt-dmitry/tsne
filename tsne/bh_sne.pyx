...
cdef class BH_SNE:
    ...
    def run(self, X, N, D, d, perplexity, theta, seed, max_iter, stop_lying_iter, mom_switch_iter):
        ...
        self.thisptr.run(&_X[0,0], N, D, &Y[0,0], d, perplexity, theta, seed, max_iter, stop_lying_iter, mom_switch_iter)
        return Y
